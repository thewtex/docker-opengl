...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.description="An image based on centos 5 containing an X_Window_System which supports rendering graphical applications, including OpenGL apps" \
